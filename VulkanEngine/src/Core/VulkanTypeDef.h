...
enum BX_FRAMEBUFFER_ATTACHMENT_LAYOUT
{
    ...
    BX_FRAMEBUFFER_ATTACHMENT_LAYOUT_ATTACHMENT_INPUT
};

enum BX_VULKAN_TEXTURE_USAGE_BITS
{
    BX_TEXTURE_USAGE_VULKAN_BEGIN            = 0x0,
    BX_TEXTURE_USAGE_VULKAN_NONE             = 0x0,
    BX_TEXTURE_USAGE_VULKAN_INPUT_ATTACHMENT = 0x10,
    BX_TEXTURE_USAGE_VULKAN_END              = 0xFFFFFFFF
};
typedef BxFlags BX_VULKAN_TEXTURE_USAGE;